...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-xs-6 m-b30 article-listbox'); ?>>
	<div class="post-thumbnail">
		<a href="<?php the_permalink(); ?>">
		<?php if ( has_post_thumbnail() ) {
			the_post_thumbnail('420-240-hard', array('class'=>'img-responsive'));
		} else { ?>
			<img src="<?php echo get_template_directory_uri(); ?>/img/default-image/Default-Image-420x240.png" alt="<?php the_title(); ?>" />
		<?php } ?>
		</a>
	...
	<div class="post-contents p-t20 p-b20 p-l10 p-r10">
		<div>
			...
			<div class="f14 entry-content">
			  <?php string_limiter(get_the_excerpt(),150); ?>
