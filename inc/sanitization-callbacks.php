 ...
 */
 ...
 /* Sanitization Function List
  *
  * medicalrehab_sanitize_text
  * medicalrehab_sanitize_checkbox
  * medicalrehab_sanitize_css
  * medicalrehab_sanitize_dropdown_pages
  * medicalrehab_sanitize_email
  * medicalrehab_sanitize_hex_color
  * medicalrehab_sanitize_html
  * medicalrehab_sanitize_image
  * medicalrehab_sanitize_nohtml
  * medicalrehab_sanitize_number_absint
  * medicalrehab_sanitize_number_range
  * medicalrehab_sanitize_select  
  * medicalrehab_sanitize_url
 */ 
 
 
 function medicalrehab_sanitize_text( $input ) {
    return wp_kses_post( force_balance_tags( $input ) );
}
 
function medicalrehab_sanitize_image_repeat( $value , $setting) {
    if ( ! in_array( $value, array( 'repeat', 'repeat-x', 'repeat-y', 'no-repeat' ) ) ){
        $value = $setting->default;
	}
    return $value;
} 

function medicalrehab_sanitize_image_size( $value , $setting) {
    if ( ! in_array( $value, array( 'initial', 'cover', 'contain' ) ) ){
        $value = $setting->default;
	}
    return $value;
} 

function medicalrehab_sanitize_image_position( $value , $setting) {
    if ( ! in_array( $value, array( 'left-top', 'center-top', 'right-top', 'left-center', 'center-center', 'right-center', 'left-bottom', 'center-bottom', 'right-bottom' ) ) ){
        $value = $setting->default;
	}
    return $value;
}			
...
function medicalrehab_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function medicalrehab_sanitize_css( $css ) {
 ...
 */
function medicalrehab_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function medicalrehab_sanitize_email( $email, $setting ) {
 ...
 */
function medicalrehab_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function medicalrehab_sanitize_html( $html ) {
 ...
 */
function medicalrehab_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function medicalrehab_sanitize_nohtml( $nohtml ) {
 ...
 */
function medicalrehab_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function medicalrehab_sanitize_number_range( $number, $setting ) {
 ...
 */
function medicalrehab_sanitize_select( $input, $setting ) {
 ...
 */
function medicalrehab_sanitize_url( $url ) {
